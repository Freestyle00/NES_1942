    ...
    {
        public partial class SliderRuntime : NES_1942.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.SliderRuntime.VariableState fromState,NES_1942.GumRuntimes.DefaultForms.SliderRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory fromState,NES_1942.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime LineInstance { get; set; }
            public NES_1942.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            public NES_1942.GumRuntimes.ContainerRuntime TrackInstance { get; set; }
            ...
            {
                LineInstance = this.GetGraphicalUiElementByName("LineInstance") as NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                ThumbInstance = this.GetGraphicalUiElementByName("ThumbInstance") as NES_1942.GumRuntimes.DefaultForms.ScrollBarThumbRuntime;
                TrackInstance = this.GetGraphicalUiElementByName("TrackInstance") as NES_1942.GumRuntimes.ContainerRuntime;
