    ...
    {
        public partial class ComboBoxRuntime : NES_1942.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.ComboBoxRuntime.VariableState fromState,NES_1942.GumRuntimes.DefaultForms.ComboBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.ComboBoxRuntime.ComboBoxCategory fromState,NES_1942.GumRuntimes.DefaultForms.ComboBoxRuntime.ComboBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public NES_1942.GumRuntimes.DefaultForms.ListBoxRuntime ListBoxInstance { get; set; }
            ...
            {
                ListBoxInstance = this.GetGraphicalUiElementByName("ListBoxInstance") as NES_1942.GumRuntimes.DefaultForms.ListBoxRuntime;
