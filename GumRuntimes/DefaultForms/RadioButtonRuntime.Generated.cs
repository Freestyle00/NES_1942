    ...
    {
        public partial class RadioButtonRuntime : NES_1942.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentRadioButtonCategoryState)
                        {
                            case  RadioButtonCategory.EnabledOn:
                                ColoredFrameInstance.CurrentColorCategoryState = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                            ...
                            case  RadioButtonCategory.DisabledOn:
                                ColoredFrameInstance.CurrentColorCategoryState = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                                ColoredFrameInstance.Blue = 255;
                                ColoredFrameInstance.Green = 255;
                                ColoredFrameInstance.Red = 255;
                                SpriteInstance.Visible = true;
                            ...
                            case  RadioButtonCategory.HighlightedOn:
                                ColoredFrameInstance.CurrentColorCategoryState = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                                ColoredFrameInstance.Blue = 255;
                                ColoredFrameInstance.Green = 255;
                                ColoredFrameInstance.Red = 255;
                                SpriteInstance.Visible = true;
            ...
            public void InterpolateBetween (RadioButtonCategory firstState, RadioButtonCategory secondState, float interpolationValue) 
            {
                ...
                NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory ColoredFrameInstanceCurrentColorCategoryStateFirstValue= NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory ColoredFrameInstanceCurrentColorCategoryStateSecondValue= NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  RadioButtonCategory.EnabledOn:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                    ...
                    case  RadioButtonCategory.DisabledOn:
                        ...
                        ColoredFrameInstanceBlueFirstValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateFirstValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setColoredFrameInstanceGreenFirstValue = true;
                        ColoredFrameInstanceGreenFirstValue = 255;
                        setColoredFrameInstanceRedFirstValue = true;
                        ColoredFrameInstanceRedFirstValue = 255;
                    ...
                    case  RadioButtonCategory.HighlightedOn:
                        ...
                        ColoredFrameInstanceBlueFirstValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateFirstValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setColoredFrameInstanceGreenFirstValue = true;
                        ColoredFrameInstanceGreenFirstValue = 255;
                        setColoredFrameInstanceRedFirstValue = true;
                        ColoredFrameInstanceRedFirstValue = 255;
                ...
                switch(secondState)
                {
                    case  RadioButtonCategory.EnabledOn:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                    ...
                    case  RadioButtonCategory.DisabledOn:
                        ...
                        ColoredFrameInstanceBlueSecondValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateSecondValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setColoredFrameInstanceGreenSecondValue = true;
                        ColoredFrameInstanceGreenSecondValue = 255;
                        setColoredFrameInstanceRedSecondValue = true;
                        ColoredFrameInstanceRedSecondValue = 255;
                    ...
                    case  RadioButtonCategory.HighlightedOn:
                        ...
                        ColoredFrameInstanceBlueSecondValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateSecondValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setColoredFrameInstanceGreenSecondValue = true;
                        ColoredFrameInstanceGreenSecondValue = 255;
                        setColoredFrameInstanceRedSecondValue = true;
                        ColoredFrameInstanceRedSecondValue = 255;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.RadioButtonRuntime.VariableState fromState,NES_1942.GumRuntimes.DefaultForms.RadioButtonRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.RadioButtonRuntime.RadioButtonCategory fromState,NES_1942.GumRuntimes.DefaultForms.RadioButtonRuntime.RadioButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime ColoredFrameInstance { get; set; }
            public NES_1942.GumRuntimes.SpriteRuntime SpriteInstance { get; set; }
            ...
            {
                ColoredFrameInstance = this.GetGraphicalUiElementByName("ColoredFrameInstance") as NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                SpriteInstance = this.GetGraphicalUiElementByName("SpriteInstance") as NES_1942.GumRuntimes.SpriteRuntime;
