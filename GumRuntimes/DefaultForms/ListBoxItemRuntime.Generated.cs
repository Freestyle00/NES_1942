    ...
    {
        public partial class ListBoxItemRuntime : NES_1942.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentListBoxItemCategoryState)
                        {
                            case  ListBoxItemCategory.Enabled:
                                BackgroundInstance.CurrentColorCategoryState = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                                RectangleInstance.Visible = false;
                                break;
                            case  ListBoxItemCategory.Highlighted:
                                BackgroundInstance.CurrentColorCategoryState = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                                BackgroundInstance.X = 0f;
                                BackgroundInstance.XOrigin = RenderingLibrary.Graphics.HorizontalAlignment.Center;
                                BackgroundInstance.XUnits = Gum.Converters.GeneralUnitType.PixelsFromMiddle;
                                BackgroundInstance.Y = 0f;
                            ...
                            case  ListBoxItemCategory.Selected:
                                BackgroundInstance.CurrentColorCategoryState = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                                RectangleInstance.Visible = false;
                                break;
            ...
            public void InterpolateBetween (ListBoxItemCategory firstState, ListBoxItemCategory secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  ListBoxItemCategory.Enabled:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                        if (interpolationValue < 1)
                        {
                            this.RectangleInstance.Visible = false;
                        }
                    ...
                    case  ListBoxItemCategory.Highlighted:
                        setBackgroundInstanceCurrentColorCategoryStateFirstValue = true;
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setBackgroundInstanceXFirstValue = true;
                        BackgroundInstanceXFirstValue = 0f;
                        if (interpolationValue < 1)
                        {
                    ...
                    case  ListBoxItemCategory.Selected:
                        setBackgroundInstanceCurrentColorCategoryStateFirstValue = true;
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                        if (interpolationValue < 1)
                        {
                            this.RectangleInstance.Visible = false;
                        }
                ...
                switch(secondState)
                {
                    case  ListBoxItemCategory.Enabled:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                        if (interpolationValue >= 1)
                        {
                            this.RectangleInstance.Visible = false;
                        }
                    ...
                    case  ListBoxItemCategory.Highlighted:
                        setBackgroundInstanceCurrentColorCategoryStateSecondValue = true;
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setBackgroundInstanceXSecondValue = true;
                        BackgroundInstanceXSecondValue = 0f;
                        if (interpolationValue >= 1)
                        {
                    ...
                    case  ListBoxItemCategory.Selected:
                        setBackgroundInstanceCurrentColorCategoryStateSecondValue = true;
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                        if (interpolationValue >= 1)
                        {
                            this.RectangleInstance.Visible = false;
                        }
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.ListBoxItemRuntime.VariableState fromState,NES_1942.GumRuntimes.DefaultForms.ListBoxItemRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.ListBoxItemRuntime.ListBoxItemCategory fromState,NES_1942.GumRuntimes.DefaultForms.ListBoxItemRuntime.ListBoxItemCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public NES_1942.GumRuntimes.RectangleRuntime RectangleInstance { get; set; }
            ...
            private void AssignReferences () 
            {
                ...
                RectangleInstance = this.GetGraphicalUiElementByName("RectangleInstance") as NES_1942.GumRuntimes.RectangleRuntime;
            }
