    ...
    {
        public partial class TextBoxRuntime : NES_1942.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            SelectionInstance.CurrentColorCategoryState = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory SelectionInstanceCurrentColorCategoryStateFirstValue= NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory SelectionInstanceCurrentColorCategoryStateSecondValue= NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        SelectionInstanceCurrentColorCategoryStateFirstValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        SelectionInstanceCurrentColorCategoryStateSecondValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.TextBoxRuntime.VariableState fromState,NES_1942.GumRuntimes.DefaultForms.TextBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.TextBoxRuntime.TextBoxCategory fromState,NES_1942.GumRuntimes.DefaultForms.TextBoxRuntime.TextBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.TextBoxRuntime.LineModeCategory fromState,NES_1942.GumRuntimes.DefaultForms.TextBoxRuntime.LineModeCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime SelectionInstance { get; set; }
            public NES_1942.GumRuntimes.TextRuntime TextInstance { get; set; }
            public NES_1942.GumRuntimes.ColoredRectangleRuntime CaretInstance { get; set; }
            public string Text
            {
                get
                {
            ...
            private void AssignReferences () 
            {
                ...
                SelectionInstance = this.GetGraphicalUiElementByName("SelectionInstance") as NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                TextInstance = this.GetGraphicalUiElementByName("TextInstance") as NES_1942.GumRuntimes.TextRuntime;
                CaretInstance = this.GetGraphicalUiElementByName("CaretInstance") as NES_1942.GumRuntimes.ColoredRectangleRuntime;
            }
