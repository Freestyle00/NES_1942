    ...
    {
        public partial class ScrollBarRuntime : NES_1942.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            BackgroundInstance.CurrentColorCategoryState = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                            Height = 384f;
                            Width = 36f;
                            X = 0f;
                            Y = 0f;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory BackgroundInstanceCurrentColorCategoryStateFirstValue= NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory BackgroundInstanceCurrentColorCategoryStateSecondValue= NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.ScrollBarRuntime.VariableState fromState,NES_1942.GumRuntimes.DefaultForms.ScrollBarRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (NES_1942.GumRuntimes.DefaultForms.ScrollBarRuntime.ScrollBarCategory fromState,NES_1942.GumRuntimes.DefaultForms.ScrollBarRuntime.ScrollBarCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime BackgroundInstance { get; set; }
            public NES_1942.GumRuntimes.DefaultForms.ButtonRuntime UpButtonInstance { get; set; }
            public NES_1942.GumRuntimes.DefaultForms.ButtonRuntime DownButtonInstance { get; set; }
            public NES_1942.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            public NES_1942.GumRuntimes.SpriteRuntime SpriteInstance1 { get; set; }
            public NES_1942.GumRuntimes.SpriteRuntime SpriteInstance2 { get; set; }
            public NES_1942.GumRuntimes.ContainerRuntime ThumbContainer { get; set; }
            ...
            {
                BackgroundInstance = this.GetGraphicalUiElementByName("BackgroundInstance") as NES_1942.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                UpButtonInstance = this.GetGraphicalUiElementByName("UpButtonInstance") as NES_1942.GumRuntimes.DefaultForms.ButtonRuntime;
                DownButtonInstance = this.GetGraphicalUiElementByName("DownButtonInstance") as NES_1942.GumRuntimes.DefaultForms.ButtonRuntime;
                ThumbInstance = this.GetGraphicalUiElementByName("ThumbInstance") as NES_1942.GumRuntimes.DefaultForms.ScrollBarThumbRuntime;
                SpriteInstance1 = this.GetGraphicalUiElementByName("SpriteInstance1") as NES_1942.GumRuntimes.SpriteRuntime;
                SpriteInstance2 = this.GetGraphicalUiElementByName("SpriteInstance2") as NES_1942.GumRuntimes.SpriteRuntime;
                ThumbContainer = this.GetGraphicalUiElementByName("ThumbContainer") as NES_1942.GumRuntimes.ContainerRuntime;
