...
namespace NES_1942.Screens
{
    public partial class GameScreen : FlatRedBall.Screens.Screen
    {
        ...
        protected static NES_1942.GumRuntimes.HUDRuntime HUD;
        ...
        private FlatRedBall.Math.Collision.PositionedObjectVsListRelationship<NES_1942.Entities.PlayerPlane, Entities.enemy_bullet> PlayerPlaneInstanceVsenemy_bulletList;
        ...
        public event System.Action<NES_1942.Entities.PlayerPlane, Entities.enemy_bullet> PlayerPlaneInstanceVsenemy_bulletListCollisionOccurred;
        NES_1942.FormsControls.Screens.HUDForms Forms;
        public GameScreen () 
        	: base ("GameScreen")
        {
        }
    ...
    More_Bullet_catchersListVsenemy_bulletList.Name = "More_Bullet_catchersListVsenemy_bulletList";
                ...
                PlayerPlaneInstanceVsenemy_bulletList = FlatRedBall.Math.Collision.CollisionManager.Self.CreateRelationship(PlayerPlaneInstance, enemy_bulletList);
    PlayerPlaneInstanceVsenemy_bulletList.Name = "PlayerPlaneInstanceVsenemy_bulletList";

            Forms = new NES_1942.FormsControls.Screens.HUDForms(HUD);
        ...
        {
            HUD.AddToManagers();FlatRedBall.FlatRedBallServices.GraphicsOptions.SizeOrOrientationChanged += RefreshLayoutInternal;
        ...
        public override void Destroy () 
        {
            ...
            BBOOMM = null;
            HUD.RemoveFromManagers();FlatRedBall.FlatRedBallServices.GraphicsOptions.SizeOrOrientationChanged -= RefreshLayoutInternal;
            HUD = null;
        ...
        public virtual void PostInitialize () 
        {
            ...
            PlayerPlaneInstanceVsenemy_bulletList.CollisionOccurred += OnPlayerPlaneInstanceVsenemy_bulletListCollisionOccurred;
            PlayerPlaneInstanceVsenemy_bulletList.CollisionOccurred += OnPlayerPlaneInstanceVsenemy_bulletListCollisionOccurredTunnel;
            if (Map!= null)
            {
            }
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if(HUD == null) HUD = (NES_1942.GumRuntimes.HUDRuntime)GumRuntime.ElementSaveExtensions.CreateGueForElement(Gum.Managers.ObjectFinder.Self.GetScreen("HUD"), true);
