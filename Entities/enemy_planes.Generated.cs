...
{
    public partial class enemy_planes : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public enemy_planes (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public enemy_planes (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void Destroy () 
        {
            if (Used)
            {
                Factories.enemy_planesFactory.MakeUnused(this, false);
            }
        ...
        public virtual void PostInitialize () 
        {
            ...
            SpriteInstance.AnimationChains = enamy_planes;
            SpriteInstance.CurrentChainName = "enemy_plane";
            ...
            AxisAlignedRectangleInstance.Height = 14f;
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("enemy_planesStaticUnload", UnloadStaticContent);
                        mRegisteredUnloads.Add(ContentManagerName);
                    }
                }
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/enemy_planes/enamy_planes.achx", ContentManagerName))
                {
                    registerUnload = true;
                }
                enamy_planes = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/enemy_planes/enamy_planes.achx", ContentManagerName);
            }
