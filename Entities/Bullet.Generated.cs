...
namespace NES_1942.Entities
{
    public partial class Bullet : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        protected static Microsoft.Xna.Framework.Graphics.Texture2D Shotgun;
        ...
        public virtual void PostInitialize () 
        {
            ...
            SpriteInstance.Texture = Shotgun;
            ...
            {
                AxisAlignedRectangleInstance.Z = 1f;
            }
            else
            {
                AxisAlignedRectangleInstance.RelativeZ = 1f;
            }
            AxisAlignedRectangleInstance.Width = 2f;
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/bullet/shotgun.png", ContentManagerName))
                {
                    registerUnload = true;
                }
                Shotgun = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/bullet/shotgun.png", ContentManagerName);
            }
