...
{
    public partial class enemy_bullet : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        protected static FlatRedBall.Graphics.Animation.AnimationChainList bullets_enamy;
        ...
        public enemy_bullet (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public enemy_bullet (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void Destroy () 
        {
            if (Used)
            {
                Factories.enemy_bulletFactory.MakeUnused(this, false);
            }
        ...
        public virtual void PostInitialize () 
        {
            ...
            SpriteInstance.AnimationChains = bullets_enamy;
            ...
            AxisAlignedRectangleInstance.Width = 4f;
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("enemy_bulletStaticUnload", UnloadStaticContent);
                        mRegisteredUnloads.Add(ContentManagerName);
                    }
                }
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/enemy_bullet/bullets_enamy.achx", ContentManagerName))
                {
                    registerUnload = true;
                }
                bullets_enamy = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/enemy_bullet/bullets_enamy.achx", ContentManagerName);
            }
