...
{
    public partial class Borders_left_right : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public Borders_left_right () 
        	: this(FlatRedBall.Screens.ScreenManager.CurrentScreen.ContentManagerName, true)
        {
        }
        public Borders_left_right (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Borders_left_right (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void Destroy () 
        {
            if (Used)
            {
                Factories.Borders_left_rightFactory.MakeUnused(this, false);
            }
        ...
        public virtual void PostInitialize () 
        {
            ...
            AxisAlignedRectangleInstance.Width = 40f;
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Borders_left_rightStaticUnload", UnloadStaticContent);
