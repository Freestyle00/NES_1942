...
{
    public partial class Border_Down : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public Border_Down (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Border_Down (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void Destroy () 
        {
            if (Used)
            {
                Factories.Border_DownFactory.MakeUnused(this, false);
            }
        ...
        public virtual void PostInitialize () 
        {
            ...
            AxisAlignedRectangleInstance.Height = 40f;
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Border_DownStaticUnload", UnloadStaticContent);
